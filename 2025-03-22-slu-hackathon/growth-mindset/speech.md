...
Today I'm going to spend some time talking about the Growth Mindset.

But before I get started with the talk, I would just like to extend a thank you
to everyone here who is involved with HackSLU; the organizers, the mentors, the
...
exceeding expectations, who's going to promote, and who's going to be getting a
really big bonus. These growth mindset qualities are also what an interviewer is
...
developer and break into the software industry.

So today we're going to break down that quote and discuss each of the qualities,
starting with:
...
and pushing the boundaries of what you think is possible. It’s about the
...
it wouldn't matter if it was a one on one, a small team meeting, or an org-wide
meeting with more than 100 people on the call, this guy had questions. These
questions, regardless of their complexity, were insightful and thought
provoking, and often sparked valuable discussions. His willingness to ask
questions and admit when he didn’t know something created an environment where
learning and growth were prioritized, and it inspired all of us developers to be
more open-minded and feel safe to ask questions.
...
on this team so difficult?" and "What do we need to do to improve it?" and this
lead to us completely revamping our developer environments into something that
is much more user-friendly and enjoyable to use. Or "Why is it so hard to debug
our code?" and as a result, we refactored large chunks of some of the most
confusing code in our codebase into something that's much more maintainable. He
wound up fulfilling the role of a Principal, leading the way on large complex
features, from design, to helping the rest of the team implement it.

In just a few months, this person had gone from being a "question asker" to
being a "question answerer". And he was able to do this because he had a
*genuine curiosity*.
...
Raise your hand if you've never been to a hackathon before.

If you've never been to a hackathon, I don't mean to scare you, but Hackathons
are hard. It's going to be a challenge. You're going to have to learn a lot of
new technologies: new databases, new languages, new libraries, frameworks, and
APIs. And it's not going to stop at tech. You might be working with new people,
people who have different ideas than you, different backgrounds. This is an
all-night event. You're going to be up late tonight, banging your head against
your code. And tomorrow, the judges are going to come around, and you'll have to
present your idea, to convince them of its value and feasibility. And yea, it's
probably going to feel awkward.
...
feel out the company, and decide if they're going to prioritize your growth.
Even if you don't get the job, every interview is a chance to learn and grow and
...
When I read about this in books and articles, I frequently see some really good
examples of this. Like, "How many free throws did Michael Jordan make before he
became a professional basketball player?" or "How many shots on goal did Mia
Hamm take before she became one of the greatest soccer players of all time?".
And these are great examples. But let's be real you guys, we're programmers, and
most of us don't know anything about sports.
...
autopilot, and eventually, you'll win the battle, and be able to progress to the
next level. The next challenge.
...
reason why community events like HackSLU are so important to me. It provides you
with a safe space where you can take risks, you can experiment, and you can
...
don't let it get you down. Use it as an opportunity to grow and improve.
Remember that failure is not the end of the world. It's just a step on the road
to mastery.
...
One of the most common forms of feedback you'll encounter in the software world
is the code review. Code reviews are an essential part of the development
process. They involve other devs examining your code to identify bugs, suggest
improvements, and ensure that best practices are followed. While it can feel
uncomfortable to have your work scrutinized, it's important to see code reviews
as a learning opportunity. Each comment and suggestion is a chance to refine
your coding skills, learn new techniques, and produce higher-quality code. If
you embrace this process with an open mind, you'll find yourself growing as a
developer.
...
some of them might be critical. It's natural to feel defensive or discouraged,
but I hope that you will approach this criticism with an open mind. Instead of
seeing it as a personal attack, view it as valuable input that can help you
refine your skills and enhance your project.

Every piece of criticism is a chance to learn something new. Maybe a judge
points out a flaw in your code that you hadn't noticed. This is an opportunity
to improve your coding practices. Or maybe they suggest a different approach to
solving a problem, like a difference design pattern, or a different library.
This is a chance to expand your problem-solving toolkit, and change the way that
you think about things.

Surrounding yourself with people who provide high-quality feedback is crucial
for your growth and success. The judges are not just here to evaluate your
projects; they genuinely want to see you succeed. They're bringing experience
and knowledge, and their constructive criticism is designed to help you refine
your ideas and improve your skills. Remember, the goal is not just to win, but
to learn and evolve through the process. By actively seeking out high-quality
feedback, you are setting yourself up for continuous improvement and long-term
success.

The goal of criticism is not to tear you down but to build you up. It's meant to
help you reach your full potential. By embracing feedback and using it to guide
your growth, you'll become a more resilient and skilled developer.
...
And real quick before I conclude, I want to make a request. As I've mentioned, I
am *not* a public speaker; I don't normally do this kind of thing. So I'm asking
you for feedback. I will be around for most of this hackathon, and I would
really love it if you came up to me and let me know what you thought of this
talk. What parts did you like? Which ones did you hate? What could I have done
better?
...
This hackathon is just a beginning. The skills you develop, the lessons you
learn, and the mindset you cultivate here will serve you well throughout your
career. Embrace every challenge, and never stop learning.

You are the next generation. The future of technology is in your hands, and with
the right mindset, there's no limit to what you can achieve. So, let's get out
there, give it your all, and make the most of this awesome opportunity.
